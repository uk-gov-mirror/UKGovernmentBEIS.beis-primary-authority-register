Feature: User management
    ...
    Scenario Outline: Add new person and invite user
        ...
        Then the element "h1.govuk-heading-l" contains the text "People"
        When I click the link text "Add a person"

        # Enter the contact details
        Then the element "h1.govuk-heading-l" contains the text "Add contact details"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Give this person a user account?"
        When I click on the radio "#edit-account-new"
        And I click on the button "#edit-next"

        # Choose authorities for the person
        Then the element "h1.govuk-heading-l" contains the text "Choose their memberships"
        When I click on the checkbox "#edit-par-component-memberships-select input"
        And I click on the button "#edit-next"

        # Choose role for the person
        Then the element "h1.govuk-heading-l" contains the text "What type of user would you like to create?"
        When I click on the radio "#edit-role-par-<role>"
        And I click on the button "#edit-next"

        # Send invitation
        Then the element "h1.govuk-heading-l" contains the text "Invite the person to create an account"
        And the element "#edit-recipient" contains the text "<email>"
        And I click on the button "#edit-next"

        # Check review page
        Then the element "h1.govuk-heading-l" contains the text "Profile review"
        ...
        # Choose authorities for the person
        Then the element "h1.govuk-heading-l" contains the text "Your new person has been created"
        And I click the link text "Done"
        Then the element "h1.govuk-heading-l" contains the text "<title> <first_name> <last_name>"
    ...
    Scenario: Check correct users can be managed
        ...
        Then the element "h1.govuk-heading-l" contains the text "Primary Authority Register"
    ...
    Scenario: Check that users can be updated
        ...
        Then the element "h1.govuk-heading-l" contains the text "Sally"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Update contact details"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Update which authorities or organisations this person belongs to"
        When I click on the button "#edit-next"

        Then the element "h1.govuk-heading-l" contains the text "Change the type of user"
        When I click on the button "#edit-next"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Thank you for updating this person"
        And I click the link text "Done"

        # Check the user details have been updated and the contact records merged.
        Then the element "h1.govuk-heading-l" contains the text "Profile"
        Then the element "h1.govuk-heading-l" contains the text "Dr Sally McHaels"
    ...
    Scenario: Check that user email addresses can be updated
        ...
        # Check the profile view page.
        Then the element "h1.govuk-heading-l" contains the text "Emily Davidson"
    ...
    Scenario: Check that existing contacts can be invited
        ...
        Then the element "h1.govuk-heading-l" contains the text "Invitation review"
        ...
        When I click on the button "#edit-save"
        Then the element "h1.govuk-heading-l" contains the text "The invitation has been sent"
    ...
    Scenario: User can be blocked and reactivated
        ...
        Then the element "h1.govuk-heading-l" contains the text "Disable this user account"
        When I click on the button "#edit-next"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Re-activate this user account"
        When I click on the button "#edit-next"
