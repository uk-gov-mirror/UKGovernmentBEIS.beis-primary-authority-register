Feature: Coordinator User - Complete organisation details
    ...
    Scenario: Coordinator User - Complete organisation details
        ...
        Then the element "h1.govuk-heading-l" contains the text "Confirm the size of the membership list"
        ...
        # Then the element "h1.govuk-heading-l" contains the text "Check partnership information"
        ...
        # Then the element "h1.govuk-heading-l" contains the text "Thank you for completing the application"
