Feature: New Direct Partnership For PA To Approve
    ...
    Scenario: Update profile with one contact record
        ...
        Then the element "h1.govuk-heading-l" contains the text "Confirm acceptance of data policy"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Update communication preferences"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Update notification preferences"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Thank you for updating your profile"
    ...
    Scenario: Update and merge profile with multiple contact records
        ...
        Then the element "h1.govuk-heading-l" contains the text "Choose which contact to update"
