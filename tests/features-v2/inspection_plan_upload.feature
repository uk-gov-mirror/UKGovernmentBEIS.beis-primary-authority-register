Feature: Upload inspection plan
    ...
    Scenario: Upload-inspection plan
        ...
        Then the element "h1.govuk-heading-l" contains the text "Upload inspection plan documents"
        When I upload the file "files/test.png" to field "#edit-inspection-plan-files-upload"
        And I click on the button "#edit-upload"
        Then the element "h1.govuk-heading-l" contains the text "Add inspection plan details"
        When I enter the inspection plan title "Auto-test-NewInspectionPlan"
        And I enter summary of inspection plan
        And I click save
        Then the element "h1.govuk-heading-l" contains the text "When does this inspeciton plan expire?"
    ...
    Scenario: Edit inspection plan
        ...
        Then the element "h1.govuk-heading-l" contains the text "Edit inspection plan details"
        ...
        Then the element "h1.govuk-heading-l" contains the text "Change the expiry date"
