...
When('the coordinated partnership creation email template is correct', function () {
 return shared
  .assert.containsText('h1.govuk-heading-l .heading-secondary','New partnership application')
  .assert.containsText('h1.govuk-heading-l','Notify user of partnership invitation')
  .waitForElementVisible('input[value=\"Invitation to join the Primary Authority Register\"]', 1000)
  .click('#edit-next')
  .assert.containsText('h1.govuk-heading-l .heading-secondary','New partnership application')
  .assert.containsText('h1.govuk-heading-l','Notification sent')
  ...
  .assert.containsText('h1.govuk-heading-l','Primary Authority Register')
});
