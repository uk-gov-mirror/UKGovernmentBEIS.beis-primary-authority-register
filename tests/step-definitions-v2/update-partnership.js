...
When('I update about the organisation', function () {
  return shared
    ...
    .assert.containsText('h1.govuk-heading-l .heading-secondary', 'Primary Authority partnership information')
    .assert.containsText('h1.govuk-heading-l', 'Information about the organisation')
...
When('I edit about the partnership', function () {
  return shared
    ...
    .assert.containsText('h1.govuk-heading-l .heading-secondary', 'Primary Authority partnership information')
    .assert.containsText('h1.govuk-heading-l', 'Information about the new partnership')
...
When('I add and subsequently edit a trading name', function () {
    return shared
      ...
      .assert.containsText('h1.govuk-heading-l', 'Add a trading name for your organisation')
      ...
      .clearValue('#edit-trading-name')
      .assert.containsText('h1.govuk-heading-l', 'Edit trading name for your organisation')
  ...
  When('I edit the main authority contact', function () {
    return shared
      ...
      .click('#edit-next')
      .assert.containsText('h1.govuk-heading-l', 'Review contact information')
...
When('I upload a file to the partnership advice section', function () {
  return shared
    ...
    .assert.containsText('h1.govuk-heading-l', 'Uploading advice documents declaration')
    ...
    .assert.containsText('h1.govuk-heading-l', 'Edit advice details')
...
return shared
      ...
      .click('#edit-next')
      .assert.containsText('h1.govuk-heading-l', 'Invite the person to create an account')
...
return shared
      ...
      .assert.containsText('h1.govuk-heading-l', 'Confirm removal of contact')
      .click('#edit-save')
  });
