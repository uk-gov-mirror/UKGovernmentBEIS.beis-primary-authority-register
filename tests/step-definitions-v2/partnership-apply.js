...
When('I apply for a direct partnership', function () {
    return shared
        ...
        .assert.containsText('h1.govuk-heading-l', 'What kind of partnership are you applying for?')
        .click('#edit-application-type-direct')
        .click('#edit-next')
        .assert.containsText('h1.govuk-heading-l', 'Declaration for a direct partnership application')
        .click('#edit-confirm')
        .click('#edit-next')
})
When('I apply for a coordinated partnership', function () {
    return shared
        ...
        .click('#edit-next')
        .assert.containsText('h1.govuk-heading-l', 'Declaration for a coordinated partnership application')
        .click('#edit-confirm')
        .click('#edit-next')
})
...
When('I enter the business name {string}', function (organisation) {
    return shared
        .assert.containsText('h1.govuk-heading-l', 'Who are you in partnership with?')
        .click('#edit-next')
        .waitForElementVisible('.error-summary', 1000)
...
When('I choose an existing business', function () {
    return shared
        .assert.containsText('h1.govuk-heading-l', 'Are you looking for one of these businesses?')
        .click('input[name="par_data_organisation_id"]:nth-child(1)')
        .click('#edit-next')
})
When('I enter the business address', function () {
    return shared
        .assert.containsText('h1.govuk-heading-l', 'Add member organisation address')
...
When('I enter the contact details for the business', function () {
    return shared
        .assert.containsText('h1.govuk-heading-l', 'Add a contact for the organisation')
...
When('I invite the business contact', function () {
    return shared
        .assert.containsText('h1.govuk-heading-l', 'Invite the business')
