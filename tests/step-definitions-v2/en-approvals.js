...
return shared
    ...
    .assert.containsText('h1.govuk-heading-l', 'Proposed enforcement action(s)')
    ...
    .click('#edit-save')
    .assert.containsText('h1.govuk-heading-l', 'Respond to notice of enforcement action')
    .assert.containsText('h1.govuk-heading-l', 'Response to notification of enforcement action sent')
