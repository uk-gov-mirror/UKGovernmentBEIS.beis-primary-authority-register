...
Then('I should see advice list page', function () {
  return shared
      .assert.containsText('h1.govuk-heading-l', 'Advice')
});
Then('I should see advice view page has the title {string}', function (string) {
  return shared
      .assert.containsText('h1.govuk-heading-l', string)
});
...
Then('I see advice updated successfully', function () {
  return shared
      ...
      .assert.containsText('h1.govuk-heading-l', 'Auto-test-NewAdvice-retest')
...
When('I archive the advice {string} with the reason {string}', function (advice, reason) {
  return shared
      ...
      .assert.containsText('h1.govuk-heading-l', 'Are you sure you want to archive this advice?')
...
When('I remove the advice {string} with the reason {string}', function (advice, reason) {
  return shared
      ...
      .assert.containsText('h1.govuk-heading-l', 'Are you sure you want to remove this advice?')
      .click('#edit-next')
