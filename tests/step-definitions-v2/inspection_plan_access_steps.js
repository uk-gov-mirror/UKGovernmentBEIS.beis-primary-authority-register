...
Then('I should see inspection plans list page', function () {
    return shared
        .assert.containsText('h1.govuk-heading-l', 'Inspection Plans')
});
...
When('I edit the inspection plan {string}', function (title) {
    return shared
        ...
        .assert.containsText('h1.govuk-heading-l', 'Edit inspection plan details')
...
Then('I see the inspection plan has updated successfully', function () {
    return shared
        ...
        .assert.containsText('h1.govuk-heading-l', 'Auto-test-NewInspectionPlan-retest')
...
When('I revoke the inspection plan {string}', function (title) {
    return shared
        ...
        .assert.containsText('h1.govuk-heading-l', 'Are you sure you want to revoke this inspection plan?')
});
...
When('I remove the inspection plan {string} with the reason {string}', function (inspection_plan, reason) {
    return shared
        ...
        .assert.containsText('h1.govuk-heading-l', 'Are you sure you want to remove this inspection plan?')
        .click('#edit-next')
